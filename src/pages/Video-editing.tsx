  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="p-3 bg-[#efefef]">
        <section className="relative min-h-[90vh] md:min-h-[85vh] bg-gradient-to-br from-[#0d0d0d] via-[#1a1a2a] to-[#2d1f3d] rounded-3xl overflow-hidden">
          <HeroNav />
      ...
      <section className="py-24 bg-[#18191c]">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center mb-20">
            <span className="text-sm uppercase tracking-[0.2em] text-purple-400 font-semibold">What We Edit</span>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {videoTypes.map((item, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1, duration: 0.5 }}
                className="p-8 bg-white/5 backdrop-blur-sm rounded-3xl border border-white/10 hover:border-purple-500/50 transition-all duration-500 text-center group"
              >
      ...
      {/* CTA Section */}
      <section className="py-24 bg-gradient-to-br from-purple-600 via-purple-500 to-[#ff4d31]">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
            Ready to Elevate Your Content?
          </h2>
          <p className="text-xl text-white/80 mb-10">
            Let's create videos that get views, engagement, and results.
          </p>
          <a
            href="tel:+919909210605"
            className="inline-flex items-center justify-center gap-2 px-12 py-5 bg-white text-purple-600 rounded-full font-bold text-lg hover:scale-105 transition-all duration-300 shadow-2xl hover:shadow-white/25"
          >
            Start Your Project
