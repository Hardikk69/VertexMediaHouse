    ...
    <>
      ...
      <main className="min-h-screen bg-emerald-50 theme-emerald">
        ...
        <div className="p-4 bg-emerald-100/50">
          <section className="relative h-auto min-h-0 md:h-[calc(100dvh-24px)] md:max-h-[calc(100dvh-24px)] 2xl:max-h-[700px] bg-gradient-to-br from-[#0a0a0a] via-[#0d1a0d] to-[#0a0a0a] rounded-xl overflow-hidden">
            <HeroNav />
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  className="p-8 rounded-3xl bg-white hover:shadow-xl hover:shadow-emerald-500/10 transition-all duration-500 group border border-emerald-100/50"
                >
