    ...
    <>
      ...
      <main className="min-h-screen bg-cyan-50/25 theme-cyan">
        ...
        <div className="p-4 bg-cyan-50/20">
          <section
            className="relative h-auto min-h-0 md:h-[calc(100dvh-24px)] md:max-h-[calc(100dvh-24px)] 2xl:max-h-[700px] bg-gradient-to-br from-[#0a0f1a] via-[#1e293b] to-[#0f172a] rounded-xl overflow-hidden"
            ...
            <div className="hero-grid-container">
              ...
              <div
                ...
                style={{
                  ...
                  backgroundImage: `
                    linear-gradient(to right, rgba(6, 182, 212, 0.25) 2px, transparent 2px),
                    linear-gradient(to bottom, rgba(6, 182, 212, 0.25) 2px, transparent 2px)
                  `
