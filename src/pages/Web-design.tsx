    ...
    <>
      ...
      <main className="min-h-screen bg-cyan-50 theme-cyan">
        ...
        <div className="p-4 bg-cyan-100/50">
          <section className="relative h-auto min-h-0 md:h-[calc(100dvh-24px)] md:max-h-[calc(100dvh-24px)] 2xl:max-h-[700px] bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] rounded-xl overflow-hidden">
            <HeroNav />
